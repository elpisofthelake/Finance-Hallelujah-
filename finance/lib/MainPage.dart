                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          courseWidget('Investment', ' Intro to Investment',
                              'img1', Color(0xffff6a65), Color(0xffff5954)),
                          SizedBox(
                            height: 20,
                          ),
                          courseWidget('Compounding', 'Stock Market', 'img2',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          courseWidget('Security', 'Banking sector', 'img3',
                              Color(0xffe9eefa), Colors.white),
                          SizedBox(
                            height: 20,
                          ),
                          courseWidget('Taxation System', 'Credit Debit VAT',
